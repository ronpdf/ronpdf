...
if(!empty($obj_consultaum->var_fid))
//{echo "nao eh nulo";}else{echo "eh nulo";}
   ...
   { 
      ...
      $obj_dbconsultaum->var_dbobs = $dados['obs'];
                ...
                if(!empty($obj_dbconsultaum->var_dbnome))
                {
                ...
                {
                echo "filme inexistente!!! (Id nao localizado)";
                }
   }
   elseif(!empty($obj_consultaum->var_fnome))
   {
      echo "sql definido";
      echo '<br>';
      ...
      $sql = mysqli_query($conn,"select id,nome,obs from filmes where nome = '$obj_consultaum->var_fnome'") or 
      die("Erro no select por nome");
      
      echo "fazendo o while";
      echo '<br>';
      while($dados=mysqli_fetch_assoc($sql))
      {
      $obj_dbconsultaum->var_dbid = $dados['id'];
      ...
      $obj_dbconsultaum->var_dbobs = $dados['obs'];
                ...
                {
                echo "filme inexistente!!! (Nome nao localizado)";    
                }
    }
   else
   {
       ...
       echo "<body style='background-color:LightGrey'>";
                echo '<center>';
                echo '<br>'.'<br>'.'<br>';
                echo "necessario preencher um dos campos: ID ou NOME";
                echo '<br>';
                echo '<br>';
